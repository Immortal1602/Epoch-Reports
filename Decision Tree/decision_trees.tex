...
\vspace{3cm}
\title{
\textbf {Decision Trees}\\ \large Epoch IIT Hyderabad
}
...
\subsection{Gini Indices}
$$Gini\ Index = \sum_{i} 1 - P_{i}^2$$
...
and 
$$Entropy (E(X)) = -\sum_{i} p_{i}log_{2}(i)$$
and
